...
The practical challenge for any such recommender system is that the competition was done on a static data, whereas the in the real world recommender system has to deal with data changing all the time, i.e. always new users adding up and new movies coming in. We couldn't find how Netflix is using recommender system on real time data and at what frequency they are retraining their models, though we have some insight from LinkedIn offline batch computing and online serving. 
